...
def embed_texts(texts: list[str]) -> list[list[float]]:
    ...
    model = get_model()
    # SECURITY/PERFORMANCE: Set batch_size=4 to balance OOM safety and 100s Render timeout
    embeddings = model.encode(texts, batch_size=4, show_progress_bar=False, convert_to_numpy=True)
